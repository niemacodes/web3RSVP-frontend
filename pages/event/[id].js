...
function Event({event}) {
  ...
  // state vars to keep track of the user account, the status of the contract transaction, & the current time: 
  ...
  /**
   * Checks if the user has all ready rsvp'd or not. If not then the user will see a button to RSVP. 
   */
  ...
  /**
   * Creates a new rsvp when passing in the deposit amount fetched from the subgraph as the transaction value.
   */
  const newRSVP = async () => {
    try{
...
/**
 * Fetches data from the subgraph from the server. 
 */
